...
## 基本信息
- **书源名称**: 🌈笔趣中文网
- **书源地址**: http://www.bqgz.cc
- **书源分组**: 笔趣
- **书源类型**: 文本 (0)
- **创建时间**: 2026-02-18 10:33:23
- **来源**: /yuedu/shuyuan/content/id/6777.html
- **发布时间**: 2025/12/13
- **下载次数**: 未知
...
```js
{
  "bookSourceComment": "笔趣中文网：http://www.bqgz.cc",
  "bookSourceGroup": "笔趣",
  "bookSourceName": "🌈笔趣中文网",
  "bookSourceType": 0,
  "bookSourceUrl": "http://www.bqgz.cc",
  "customOrder": 0,
  "enabled": true,
  ...
  "lastUpdateTime": "1765622392658",
  "loginUrl": "http://m.bqgz.cc",
  "respondTime": 180000,
  "ruleBookInfo": {
    "author": ".novelinfo-l li:nth-child(1) > a@text",
    "coverUrl": ".novelinfo-r > img@src",
  ...
  "searchUrl": "http://www.bqgz.cc/search/result.html?searchkey={{key}}",
  "weight": 0
}
```
