...
## 基本信息
- **书源名称**: 🍓番茄免费小说-[春节限定版]
- **书源地址**: http://rose.novel.lzink.icu
- **书源分组**: 未分类
- **书源类型**: 文本 (0)
- **创建时间**: 2026-02-18 10:32:06
- **来源**: /yuedu/shuyuan/content/id/6932.html
- **发布时间**: 02/07 15:00
- **下载次数**: 未知
...
```js
{
  ...
  "bookUrl": "http://rose.novel.lzink.icu/api/detail?bookId={{$.book_id}}",
...
```js
{
  ...
  "chapterUrl": "/api/sdkapi?item_id={{$.item_id}}",
...
```js
{
  ...
  "bookSourceType": 0,
  "bookSourceUrl": "http://rose.novel.lzink.icu",
  "customOrder": 0,
  "enabled": true,
