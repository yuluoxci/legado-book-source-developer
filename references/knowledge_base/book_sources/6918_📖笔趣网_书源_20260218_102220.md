...
## 基本信息
- **书源名称**: 📖笔趣网
- **书源地址**: http://www.bqgu.cc
- **书源分组**: 笔趣网
- **书源类型**: 文本 (0)
- **创建时间**: 2026-02-18 10:22:20
- **来源**: /yuedu/shuyuan/content/id/6918.html
- **发布时间**: 未知
- **下载次数**: 未知
...
```js
{
  "bookSourceComment": "笔趣网：http://www.bqgu.cc",
  "bookSourceGroup": "笔趣网",
  "bookSourceName": "📖笔趣网",
  "bookSourceType": 0,
  "bookSourceUrl": "http://www.bqgu.cc",
  "customOrder": 0,
  "enabled": true,
  ...
  "lastUpdateTime": "1770040445320",
  "loginUrl": "http://m.bqgu.cc",
  "respondTime": 180000,
  "ruleBookInfo": {
    "author": ".novelinfo-l li:nth-child(1) > a@text",
    "coverUrl": ".novelinfo-r > img@src",
  ...
  "searchUrl": "http://www.bqgu.cc/search/result.html?searchkey={{key}}",
  "weight": 0
}
```
